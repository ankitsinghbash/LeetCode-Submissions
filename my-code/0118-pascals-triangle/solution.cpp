 ...
 class Solution { public: vector<vector<int>> generate(int numRows) { int n = numRows; vector<vector<int>> ans; if( n == 1) { 		
     	// edge case just push {1} to ans vec tor
          ans.push_back({1}); } if(n == 2) { 
